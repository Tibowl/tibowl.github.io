    ...
    const eventConfigDefs = {
        ...
        "2019spring-lovecoal0928": {
            ...
            shipPositions: [
                ...
                {"x": 176+249 *3, "y": 470 + 139* 5, "id":  67}, // Atago
                ...
                {"x": 176+249 *0, "y": 470 + 139* 7, "id":  45}, // Yuudachi

                {"x": 176+249 *0, "y": 566 + 139* 8, "id": 126}, // I-168
                {"x": 176+249 *1, "y": 566 + 139* 8, "id": 128}, // I-8
                {"x": 176+249 *2, "y": 566 + 139* 8, "id": 191}, // I-19
                
                {"x": 176+249 *0, "y": 824 + 139* 9, "id": 110}, // Shoukaku
                {"x": 176+249 *1, "y": 824 + 139* 9, "id": 111}, // Zuikaku
                {"x": 176+249 *2, "y": 824 + 139* 9, "id":  85}, // Kirishima
                {"x": 176+249 *3, "y": 824 + 139* 9, "id":  94}, // Sazanami
                {"x": 176+249 *4, "y": 824 + 139* 9, "id":  16}, // Ushio
            ],
        },
